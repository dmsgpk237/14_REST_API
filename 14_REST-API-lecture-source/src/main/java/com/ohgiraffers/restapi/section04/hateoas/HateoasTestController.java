...
public class HateoasTestController {
    ...
    * 제공함으로써 클라이언트가 리소스(지원)에 대한 이해를 더욱 충분히
    * 할 수 있도록 링크를 제공하는 것.
    *
    ...
    * */
    ...
    public ResponseEntity<ResponseMessage> findAllUsers() {
        ...
        // EntityModel : hateoas에서 제공하는 클래스, rest api를 만들 때
        ...
        return ResponseEntity.ok().headers(headers).body(new ResponseMessage(200, "전체 조회 성공", responseMap));
